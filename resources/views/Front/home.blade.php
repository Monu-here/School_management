                                ...
                                <div class="row justify-content-start">
                                    <div class="col-sm-10 col-lg-8">
                                        <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Best Online
                                            Courses</h5>
                                        <h1 class="display-3 text-white animated slideInDown">{{ $slider->short_desc }}</h1>
                                        <p class="fs-5 text-white mb-4 pb-2">{{ $slider->long_desc }}</p>
                                        <a href=""
                ...
                @foreach ($services as $service)
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item text-center pt-3">
                            <div class="p-4">
                                <img src="{{ asset($service->image) }}" alt="" class="text-primary mb-4"
                                    width="90">
            ...
            <div class="row g-5">
                @foreach ($abouts as $about)
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <p class="mb-4">{{ $about->short_desc }}</p>
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="img-fluid position-absolute w-100 h-100" src="{{ $about->image }}" alt=""
